        ...
        if let detailedMeal = detailedMeal {
            ScrollView {
                ...
                Text("Måltid Navn: \(detailedMeal.strMeal)")
                    .font(.headline)
                if detailedMeal.strCategory != nil {
                    HStack {
                        TextField("Kategori endring", text: $editCategory)
                        
                        Button(action: {
                            if let firstCategory = category.first {
                                firstCategory.strCategory = editCategory
                            }
...
//
//struct EditCategoriesView_Preview: PreviewProvider {
...
//
//
//        EditCategoriesView(meal: sampleMeal, mealID: "1234")
//    }
//}
