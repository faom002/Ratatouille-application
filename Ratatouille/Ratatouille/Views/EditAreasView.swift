...
struct EditAreasView: View {
    ...
    @State private var isFlagSelectionPresented = false
                ...
                if let data = data {
                    do {
                        ...
                        DispatchQueue.main.async {
                            if let detailedMeal = response.meals.first {
...
//
//struct EditAreasView_Preview: PreviewProvider {
...
//
//       
//        EditAreasView(meal: sampleMeal, mealID: "1234")
//    }
//}
